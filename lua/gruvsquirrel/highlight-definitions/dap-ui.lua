...
local attributes = mapper.highlight_group_mapper {
  ...
  { { g.DapUIStop, g.DapUIStopNC, g.DapUIWatchesEmpty, g.DapUIWatchesError, }, d.lemon_balm },
  {
    { g.DapUIBreakpointsInfo,
      g.DapUIPlayPause,
      g.DapUIPlayPauseNC,
      g.DapUIRestart, g.DapUIRestartNC,
      g.DapUIThread,
      g.DapUIWatchesValue,
    }, d.ginkgo_nut
  },
  ...
  { { g.DapUIBreakpointsLine, g.DapUIBreakpointsPath, g.DapUIDecoration, g.DapUIFloatBorder, g.DapUILineNumber,
    g.DapUIScope, g.DapUIStepBack, g.DapUIStepBackNC, g.DapUIStepInto, g.DapUIStepIntoNC, g.DapUIStepOut,
    g.DapUIStepOutNC, g.DapUIStepOver, g.DapUIStepOverNC, g.DapUIStoppedThread, }, d.indian_nut },
