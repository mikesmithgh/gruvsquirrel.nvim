...
local M = {
  attributes = function()
    ...
    return mapper.highlight_group_mapper {
      ...
      { { g.DevIconDefaultCurrent },      d.dwayne },
      { { g.DevIconDefaultVisible },      d.dowatnut },
      { { g.DevIconDefaultInactive },     d.dwayne },
