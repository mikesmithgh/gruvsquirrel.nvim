...
local attributes = mapper.highlight_group_mapper {
  ...
  { { g.GitSignsAddLnInline, g.GitSignsAddInline, g.GitSignsDeleteInline, g.GitSignsDeleteLnInline, g.GitSignsDeleteVirtLnInLine, }, d.beechnut },
  { { g.GitSignsAddLn, g.GitSignsAddPreview, g.GitSignsChangeLn, g.GitSignsUntrackedLn, g.GitSignsStagedAddLn, g.GitSignsStagedChangeLn, }, d.black_walnut },
  ...
  { { g.GitSignsCurrentLineBlame }, d.butternut },
